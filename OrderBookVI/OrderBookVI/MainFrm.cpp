...
BOOL CMainFrame::CreateOutlookBar(CMFCOutlookBar& bar, UINT uiID, CFileExplorerTreeCtrl& tree, CCalendarBar& calendar, int nInitialWidth)
{
	bar.SetMode2003();
	...
	tree.SetFileExt(_T("csv"));
	tree.SetFlags(tree.GetFlags()|SHCONTF_NONFOLDERS);
...
void CMainFrame::addDebugString(LPCTSTR str)
{
